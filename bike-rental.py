...
day_df = pd.read_csv('https://raw.githubusercontent.com/raihanazhar05/Bikerental-data/main/cleaned_day_data.csv')
hour_df = pd.read_csv('https://raw.githubusercontent.com/raihanazhar05/Bikerental-data/main/cleaned_hour_data.csv')
